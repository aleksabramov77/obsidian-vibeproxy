    ...
    async onload() {
        ...
        this.addCommand({
            ...
            editorCallback: async (editor, view) => {
                ...
                if (!selection) {
                    new obsidian_1.Notice("Пожалуйста, выделите текст для отправки.");
                    return;
                }
                new obsidian_1.Notice("Отправка запроса в VibeProxy...");
                try {
                    ...
                    new obsidian_1.Notice("Ошибка при обращении к VibeProxy. Проверьте консоль.");
                }
            },
        });
...
class VibeProxySettingTab extends obsidian_1.PluginSettingTab {
    ...
    display() {
        ...
        new obsidian_1.Setting(containerEl)
            ...
            .setDesc("Укажите URL вашего локального прокси (например, http://localhost:8080/v1)")
            .addText((text) => text
        ...
        new obsidian_1.Setting(containerEl)
            .setName("Model")
            .setDesc("Название модели, которую ожидает OpenAI API (например, gpt-4o или gpt-4)")
            .addText((text) => text
